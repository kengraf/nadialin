...
declare -a arr=("backupEvent" "databaseItems" "doServiceCheck" "endScoring" "eventScores" "instanceState" "manageInstance" "restoreEvent" "rutimeInstances" "setupScoring" "startScoring" "verifyToken")
for i in "${arr[@]}"
do
  zip $i.zip $i.py
